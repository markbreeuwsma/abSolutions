...
namespace DatabaseModel.Migrations
{
    ...
    [Migration("20181126185747_RenamedToSingular")]
    partial class RenamedToSingular
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatabaseModel.CountryDescription", b =>
                {
                    ...
                    b.ToTable("CountryDescription");
                });

            modelBuilder.Entity("DatabaseModel.FieldOfInterest", b =>
                {
                    b.Property<string>("FieldOfInterestId")
                        .HasMaxLength(5);
                    ...
                    b.HasKey("FieldOfInterestId");

                    b.ToTable("FieldOfInterest");
                });

            modelBuilder.Entity("DatabaseModel.FieldOfInterestDescription", b =>
                {
                    b.Property<string>("FieldOfInterestId")
                        .HasMaxLength(5);
                    ...
                    b.HasKey("FieldOfInterestId", "LanguageId");

                    b.HasIndex("LanguageId", "FieldOfInterestId")
                        .IsUnique();

                    b.ToTable("FieldOfInterestDescription");
                });
            ...
            modelBuilder.Entity("DatabaseModel.FieldOfInterestDescription", b =>
                {
                    b.HasOne("DatabaseModel.FieldOfInterest", "FieldOfInterest")
                        .WithMany("Descriptions")
